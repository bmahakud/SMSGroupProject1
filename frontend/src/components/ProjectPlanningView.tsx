...
> = ({ onProjectCreated }) => {
  ...
  /*
   * Open the native calendar when the user clicks anywhere
   * inside the date input, not only on the calendar icon.
   */
  const openDatePicker = (
    ...
    if (typeof input.showPicker === 'function') {
      try {
        ...
        // Ignore browser/security errors and keep native behavior.
      }
    }
  };
